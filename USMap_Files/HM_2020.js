...
function render() {
    ...
    function generateData() {
        ...
        var vals = [0,0,1080000,571000, 72000, 368000,50500, 47000, 102000, 25000, 41000, 191000, 21400, 27500,29100, 317000, 293000, 116000, 29500, 285000, 115500, 0, 0, 49000, 17000,175000, 81500, 1020000, 74000, 49500, 410000, 92500, 0, 56000, 456500, 50000, 906000, 86000, 29000, 30000, 295000, 29000, 171000, 77500, 0, 3890000, 69000, 108000,74500, 40000,16600];
        console.log(states)
        console.log(vals)
        function dataArray() {
            var data = [];
