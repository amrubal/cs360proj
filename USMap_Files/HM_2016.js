...
function render() {
    ...
    function generateData() {
        ...
        var vals = [0,0, 940000, 406000,42000, 350000, 27000,13800, 60500, 12700, 27500, 219000, 14800, 29000, 16700,274000,196000, 145500,46000,209000,75000, 0,0,30700, 26000, 166000, 91500,1005000, 70500,24800, 352000, 63500, 0, 54000, 229000, 36000, 845000,83500, 18000, 27500, 291000, 22000, 148500, 38500, 0, 3760000, 42500, 111000, 111000,30500, 8300 ];
        console.log(states)
        console.log(vals)
        function dataArray() {
            var data = [];
